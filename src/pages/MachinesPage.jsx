...
import { machineCategories, machinesData } from "../data/mockData";
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="p-2 rounded hover:bg-gray-100 hover:text-gray-600 cursor-pointer transition-colors text-gray-400 hover:bg-gray-100"
            >
              <List />
            </button>
            <button
            ...
            <button className="p-2 rounded bg-blue-100 text-blue-600 cursor-pointer hover:text-blue-700 transition-colors rounded bg-blue-100 text-blue-600">
              <LayoutGrid />
            </button>
          </div>
        </div>
