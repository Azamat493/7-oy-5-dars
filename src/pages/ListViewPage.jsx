...
import { categories, textOnlyData } from "../data/mockData";
  ...
  return (
    <div className="contaner w-[95%] mx-auto  px-4 py-6">
      ...
      <div className="flex justify-between items-center mb-6">
        <div className="flex flex-col gap-8">
          ...
          <div className="flex gap-2">
            <button className="p-2 cursor-pointer rounded bg-blue-100 text-blue-600 hover:bg-blue-200 hover:text-blue-700 transition-colors">
              <List />
            </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {textOnlyData.map((item, idx) => (
          <ProductCard key={idx} item={item} variant="minimal" />
        ))}
      </div>
